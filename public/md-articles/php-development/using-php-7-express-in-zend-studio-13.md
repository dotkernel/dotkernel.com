...
This article will cover the steps needed in order to check the PHP7 compatibility, a small troubleshooter.
...
- If you only need a specific interpreter for a specific project you can check "Enable Project specific settings" by checking this option you won't affect the other projects in the current workspace
...
- download the latest **Zend Framework 1** version from [here](http://framework.zend.com/downloads/latest#ZF1), make sure you choose the **Full** option, not the **Full Package** one
...
After the analysis was done, you should see the **PHP 7 Express** view (or tab) in the bottom pane in Zend Studio (this depends on the perspective).
