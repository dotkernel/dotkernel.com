...
With the recent release of [AlmaLinux OS 10](https://almalinux.org/blog/2025-05-27-welcoming-almalinux-10/), we have created a new recipe for our WSL development environment. Compared to its predecessor, AlmaLinux 10 provides performance enhancements, security updates and improved hardware support.

## What You Get

Like for [AlmaLinux 9](https://www.dotkernel.com/php-development/almalinux-9-in-wsl2-install-php-apache-mariadb-composer-phpmyadmin/), the WSL recipe sets up the development environment with all the components a regular PHP developer needs:
...
An **easier way** to run your applications is via virtual hosts. The full instructions to set up your virtual hosts are in the [Create virtualhosts page](https://docs.dotkernel.org/development/v2/virtualhosts/create-virtualhost/).
...
If you run into any issues, make sure to first check our [FAQ page](https://docs.dotkernel.org/development/v2/faq/). If all else fails, [create an issue](https://github.com/dotkernel/development/issues) with details and we can talk.
...
A: First check the Dotkernel FAQ page. If that doesn't resolve it, create an issue on the dotkernel/development GitHub repository with details.
