...
In hosted software development, an environment is a server tier designated to a specific stage of a release process. The three most common environments are Development, Staging and Production, and applications are typically moved between them using Subversion source control.
