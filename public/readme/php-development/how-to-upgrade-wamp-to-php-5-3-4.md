...
2. Go to [windows.php.net](http://windows.php.net/download/) and download the latest ZIPPED package for PHP 5.3.4. Make sure it is the **VC6 Thread Safe build** — do not download the installer.
